 ...
 * @author fberrocalm
 */
public class HomologacionHexamenes extends javax.swing.JFrame {
    ...
    /**
     * Creates new form HomologacionHexamenes
     *
     * @param heiIn
     */
    public HomologacionHexamenes(Homo_exa_imat heiIn) {
        initComponents();
        ...
        txt_idservicio.setText(hei.getId_servicio());
        txt_laboratorio.setText(hei.getDetalle_servicio());
        txt_idalterna.setText(hei.getId_alterna());
        txt_idwinsislab.setText(hei.getId_winsis());
        if (hei.getId_compwinsis().equals("null")) {
            txt_idcompwinsis.setText("");
        } else {
            txt_idcompwinsis.setText(hei.getId_compwinsis());
        }
    ...
    private void initComponents() {
        ...
        setTitle("HOMOLOGACIÓN DE EXÁMENES EN WINSISLAB");
        ...
        txt_idcompwinsis.setEnabled(false);

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Utiles/Busqueda.png"))); // NOI18N
        jButton3.setToolTipText("Busqueda de códigos Winsislab...");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Utiles/database.png"))); // NOI18N
        jButton1.setText("Homologar examen en Winsislab");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txt_idservicio.getText().isEmpty() || txt_laboratorio.getText().isEmpty() || txt_idalterna.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Complete los datos que son necesarios para la homologación");
        } else if (txt_idwinsislab.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Por favor ingrese el \n código de laboratorio \nWinsislab para homologación");
        } else {
            int confirmado = JOptionPane.showConfirmDialog(this, "Confirme que desea realizar la homologación..");
            if (JOptionPane.OK_OPTION == confirmado) {
                try {
                    ...
                    gHomo_exa_imat.save(hei);
                    Prueba1.homologacion.setModel(gHomo_exa_imat.listarExamenesHomologados());
                } catch (NotFoundException | SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Error: no se pudo realizar la homologación: \n " + ex.getMessage());
                }
            } else {
    ...
    private void jButton3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton3KeyPressed
        // TODO add your handling code here:
        new ListaExamenes(cwinsislab.getCon()).setVisible(true);
    ...
    public static javax.swing.JTextField txt_idwinsislab;
